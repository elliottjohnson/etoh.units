...
(define-unit-list
  ...
  ((lbs/gal lbs/gals) (/ lbs gal)) ;; Assume US here, yes I know, sorry world.
  ((lbs/1000 pounds-per-thousand pounds-per-thousand-gallons)
   (/ lbs (1000 gallons)))

  ;; Inverse units of regular use.
  ((1/mole 1/mol) (/ 1 mol))
  ((gal/lbs gals/lbs gallons/pounds)
   (/ gal lbs))
  ...
  ((parts-per-thousand ‰ pp-thousand ppk) 0.001)
  ...
  ((teaspoon-metric-kitchen kitchen-teaspoon kitchen-tsp) (5 ml))
  ((dessertspoon-metric-cooking dsp-cooking dssp-cooking) (2 kitchen-tsp))
  ((drop-metric-medical drop-medical) (/ ml 12))
  ((drop-metric) (50 liters micro))
  ((polypin-metric) (20 liters))
  ((minipin-metric) (/ polypin-metric 2))
  ((fluid-ounce-us-food floz-us-food us-food-labeling-fluid-ounce) (30 ml))
  ...
  ((barrel-us-whiskey bbl-us-whiskey american-standard-barrel bbl-asb) (53 gal))
